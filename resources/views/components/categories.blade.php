                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 flex justify-center">Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
            ...
            <form action="{{ route('category.post') }}" method="POST">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Name</label>
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product categroy" required="">
                    </div>
                </div>
