...
<x-layout>
    ...
    @endif
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5 h-auto space-y-4">
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <form class="flex flex-wrap items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-4" method="GET" action="{{ route('sales.report') }}">
                    ...
                    <input type="date" name="start_date" value="{{ $startDate }}" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-200">To:</label>
                    <input type="date" name="end_date" value="{{ $endDate }}" class="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100">
