...
<body>
    ...
    <p>Tanggal: {{ $saleItem->first()->created_at->format('d-m-Y H:i') }}</p>
    ...
    <div style="text-align:right; margin-top:20px;font-weight:200;">
        <div style="margin-bottom:3rem">
            Jati Kopi {{ $saleItem->first()->created_at->format('d-m-Y H:i') }}
        </div>
        <strong>
