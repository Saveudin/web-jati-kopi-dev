                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{ $item->category->name }}</th>
                                    ...
                                    <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
                                        ...
                                        <form action="{{ route('product.update', ['id' => $item->id]) }}" method="POST">
                                            ...
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    <label for="unit" class="block mb-2 text-sm font-medium text-gray-900">Category</label>
